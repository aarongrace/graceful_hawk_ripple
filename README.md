...
**Graceful Hawk** is an extension of the Hawk emulator of the SMAL32 assembly language created by Dr. Douglas Jones.
...
**Ripple** can be run on the original Hawk emulator, but it looks much better on Graceful Hawk because each hex number is given a distinct color, giving the impression of undulation and depth. In addition, the original Hawk emulator does not have animation, so the frames would have to be advanced manually. 
